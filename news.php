...
?>
    ...
    <main class="newsMain">
        ...
        <div class="newsImg">
            <img src="assets/img/news/bg.jpg" alt="NEWS">
        </div>
        ...
        <div class="newsTxt">
            ...
            <div class="newsMap">
                ...
                <p>-</p>
                <a href="sustainability">NEWS</a>
            </div>
            
            <h1 class="detayHeadernews">NEWS</h1>
            <h2 class="detayHeadernews">Stay Informed with the Latest Updates from Us</h2>
