          ...
          Parolanızı Sıfırlayın</h5>
            ...
            <div class="col mb-3 mt-3">
                <label for="confirm_password"><i 
                  class="fa fa-lock"></i> Şifre Tekrar</label>
            ...
            <div class="col mb-2 mt-4">
                ...
                color: navy;"><a href="./register.php"
                        ...
                        Hesap Oluştur</a> & <a href="./login.php"
                        style="text-decoration: none;">Giriş Yap</a></p>
            </div>
        </form>
    </div>
    <script>
