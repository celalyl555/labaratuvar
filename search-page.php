...
?>
    ...
    <main class="newsMain">
        ...
        <div class="newsImg">
            <img src="assets/img/news/search-bg.jpg" alt="Search">
        </div>
        ...
        <div class="newsTxt">
            ...
            <div class="newsMap">
                ...
                <p>-</p>
                <a href="sustainability">SEARCH</a>
            </div>
            
            <h1 class="detayHeadernews">Arama Metini Burada Yazacak</h1>

            
            <h2 class="detayHeadernews searchtxt">Displaying <span>1547</span> Results</h2>
    ...
    <section class="detayIcerik">
        ...
        <div class="detayscreen news">
            <div></div>
            <div></div>
            <div class="newsnone1"></div>
            <div class="newsnone"></div>
            <div class="newsnone"></div>
        </div>

        <div class="detayInsideTxt p-0 news">

            <div class="haber news">

                <div class="haberHeader news">
                    <a href="news-detay" class="newsA">
                        <div class="newsLeftRed"></div>
                        <p class="mb-2">Eurolab appointed by international ECO LABEL programme</p>
                ...
                <div class="haberHeader news">
                    <a href="news-detay" class="newsA">
                        <div class="newsLeftRed"></div>
                        <p class="mb-2">Eurolab Re-Launches Sustainable Solutions Platform</p>
                        <p class="btnheader trust btnNews"><span>READ MORE</span><svg fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M14.707,20.707a1,1,0,0,1-1.414-1.414L19.586,13H2a1,1,0,0,1,0-2H19.586L13.293,4.707a1,1,0,0,1,1.414-1.414l8,8a1,1,0,0,1,.216.325.986.986,0,0,1,0,.764,1,1,0,0,1-.216.325Z"/></svg></p>
                    </a>
                </div>
                ...
                <div class="haberHeader news">
                    <a href="news-detay" class="newsA">
                        <div class="newsLeftRed"></div>
                        <p class="mb-2">Eurolab to Provide Conformity Assessment Services Globally</p>
                        <p class="btnheader trust btnNews"><span>READ MORE</span><svg fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M14.707,20.707a1,1,0,0,1-1.414-1.414L19.586,13H2a1,1,0,0,1,0-2H19.586L13.293,4.707a1,1,0,0,1,1.414-1.414l8,8a1,1,0,0,1,.216.325.986.986,0,0,1,0,.764,1,1,0,0,1-.216.325Z"/></svg></p>
                    </a>
                </div>
            ...
            <div class="pageNumber">
                ...
                <button class="pagebtn">15</button>
            </div>
