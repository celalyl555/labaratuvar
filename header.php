                            ...
                            <div class="menu-container">
                                <ul class="menu">
                                    ...
                                    <li class="menu-item has-submenu">
                                        ...
                                        <ul class="submenu">
                                            <li><a href="">Automotive Testing</a></li>
                                    ...
                                    <li class="menu-item has-submenu">
                                        ...
                                        <span class="toggle-btn"></span>
                                        <ul class="submenu">
                                            <li>Base & commodity chemicals</li>
    ...
    <header class="header">
        ...
        <div class="top-header">
            ...
            <div class="topright">
                ...
                <div class="searchbox">
                    <input class="search-input" placeholder="What are you looking for?" type="text" id="search-input">
                    <button type="button" class="search-button" id="search-button">
                        ...
                        <span class="nonesearch">SEARCH</span>
                    </button>
                </div>

                <button class="searchico">
                    <svg class="svgss active" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.9536 14.9458L21 21M17 10C17 13.866 13.866 17 10 17C6.13401 17 3 13.866 3 10C3 6.13401 6.13401 3 10 3C13.866 3 17 6.13401 17 10Z" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                    <svg class="svgs" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M20.7457 3.32851C20.3552 2.93798 19.722 2.93798 19.3315 3.32851L12.0371 10.6229L4.74275 3.32851C4.35223 2.93798 3.71906 2.93798 3.32854 3.32851C2.93801 3.71903 2.93801 4.3522 3.32854 4.74272L10.6229 12.0371L3.32856 19.3314C2.93803 19.722 2.93803 20.3551 3.32856 20.7457C3.71908 21.1362 4.35225 21.1362 4.74277 20.7457L12.0371 13.4513L19.3315 20.7457C19.722 21.1362 20.3552 21.1362 20.7457 20.7457C21.1362 20.3551 21.1362 19.722 20.7457 19.3315L13.4513 12.0371L20.7457 4.74272C21.1362 4.3522 21.1362 3.71903 20.7457 3.32851Z" fill="#0F0F0F"/>
                    </svg>
                </button>

                <div class="langArea">
                    <img src="assets/img/icons/world.svg" alt="lang">
                </div>

                <button class="menubtn">
                    <svg id="menuButton" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div id="div1" class="hidden content-div">
